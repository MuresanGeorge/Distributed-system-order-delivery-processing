 ...
 * 
 */
@WebServiceClient(name = "ClientServiceImplService", targetNamespace = "http://client/", wsdlLocation = "http://localhost:8082/client?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTSERVICEIMPLSERVICE_QNAME = new QName("http://client/", "ClientServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/client?wsdl");
    ...
    public ClientService getClientServiceImplPort() {
        return super.getPort(new QName("http://client/", "ClientServiceImplPort"), ClientService.class);
    }
    ...
    public ClientService getClientServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://client/", "ClientServiceImplPort"), ClientService.class, features);
    }
