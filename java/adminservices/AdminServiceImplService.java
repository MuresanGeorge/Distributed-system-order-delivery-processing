 ...
 * 
 */
@WebServiceClient(name = "AdminServiceImplService", targetNamespace = "http://admin/", wsdlLocation = "http://localhost:8083/admin?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICEIMPLSERVICE_QNAME = new QName("http://admin/", "AdminServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8083/admin?wsdl");
    ...
    public AdminService getAdminServiceImplPort() {
        return super.getPort(new QName("http://admin/", "AdminServiceImplPort"), AdminService.class);
    }
     ...
     */
    @WebEndpoint(name = "AdminServiceImplPort")
    public AdminService getAdminServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://admin/", "AdminServiceImplPort"), AdminService.class, features);
    }
